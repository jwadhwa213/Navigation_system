    ...
    */
    ...
    while(true){
        ...
        if(msg_rec[0] == 'N'){
            ...
            if(msg_rec[0] == 'N' && msg_rec[2] == '0'){
            ...
            else if(msg_rec[0] == 'N' && msg_rec[2] == '1' && msg_rec[3] == '\0'){
                /// need to remove this
                // cout << msg_rec[0] << " " << msg_rec[2] << " " << msg_rec[3] << endl;
                ...
                if (msg_rec[0] != E){
                    ...
                    // cout << "Sended the E message to plotter\n";
        ...
        if (msg_rec[0] != E){
            ...
            out_msg[1]='\n';
            bytes_written = write(out, out_msg , sizeof out_msg);
            // cout << "After sending the E message to plotter\n";
